...
let sortedMoreThan50Times = sortedArr.filter(
  (sortedArrCell) => sortedArrCell[1] >= 50
);

console.log("more than 50", sortedMoreThan50Times);

let least10Frequent = sortedArr.filter((least) => least[1] >= 50);
console.log("least 10", least10Frequent);

let ascendingSortedArr = Object.entries(result).sort((a, b) => a[1] - b[1]);
